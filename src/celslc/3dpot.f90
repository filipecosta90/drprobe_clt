...
external :: ODDCC128, ODDCC256, ODDCC512, ODDCC1024
  ...
  write(unit=M3D_out,fmt='(A)') "!!!!!M3D_FF1D"
...
external :: ODDCC128S, ODDCC256S, ODDCC512S, ODDCC1024S
  external :: ODDCC2048S, ODDCC4096S, ODDCC8192S ! link FFTs.f
    ...
    write(unit=M3D_out,fmt='(A)')  "!!!!!!!! M3D_FFT2D "
  ...
  write(unit=M3D_out,fmt='(A)')  "!!!!!!!! Forward 128 "

    call date_and_time(values=values)
      print *, values(5),":",values(6),":",values(7),":",values(8)
  call dfftw_plan_dft_2d_ ( plan_forward, nx, ny, dat, out, FFTW_FORWARD, &
    FFTW_ESTIMATE )
  ...
  write(unit=M3D_out,fmt='(A)')  "!!!!!!!! Backward 128 "
      call ODDCC128S(dat,nx,ny,direction)
      endif
...
character(len=80) :: sline
  ...
  external :: UPPERCASE
      ...
      write(unit=M3D_out,fmt='(A)')  "!!!!!!!! M3D_FFT3D "
...
n3 = M3D_n3
      ...
      write(unit=M3D_out,fmt='(A)') "!!!!!!!! M3D_OrthoGamma "
